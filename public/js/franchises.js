...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const addFranchiseOverlay = document.querySelector("#add-franchise-modal-overlay");
  const addFranchiseOpenButton = document.querySelector("#add-franchise");
  const addFranchiseCancelButton = document.querySelector("#cancel-add-franchise");
